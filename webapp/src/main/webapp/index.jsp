    ...
    <%--<div class="am-container header">
        ...
        <ul class="message-r">
            ...
            <div class="topMessage my-shangcheng">
                <div class="menu-hd MyShangcheng"><a href="user/usercenter.jsp" target="_top"><i class="am-icon-user am-icon-fw"></i>个人中心</a></div>
            </div>
        ...
        <div class="marqueen">
            ...
            <div class="demo">
                ...
                <ul>
                    ...
                    <li class="title-first"><a target="_blank" href="#">
                        <span>[公告]</span>商城与北京市金科教育签署战略合作协议
                    ...
                    <div class="mod-vip">
                        <div class="m-baseinfo">
                            ...
                            <em>
                                Hi,<span class="s-name" id="uuser">小叮当</span>
                                <a href="#"><p>点击更多优惠活动</p></a>
                            </em>
                        </div>
                        <div class="member-logout" id="usertologin2">
                            <input id="username2" type="hidden" value="${user.uname}">
                            <script>
                                //alert($('#username2').val()) ;

                                if($('#username2').val() != null & $('#username2').val() !=""){
                                    var html="<a href='usercenter.jsp'><font color='red'>${user.uname}</font></a>，<a href='zhuxiao.jsp'>退出登录</a>";
                                    alert(html)
                                    $('#uuser').html(html);
                                    $('#usertologin2').html();
                                }else{
                                    var html="<a class='am-btn-warning btn' href='login.jsp'>登录</a>" +
                                        " <a class='am-btn-warning btn' href='register.jsp'>注册</a>";
                                    $('#usertologin2').html(html);
                                }
...
<script>
    window.jQuery || document.write('<script src="basic/js/jquery-1.7.min.js "><\/script>');
</script>
